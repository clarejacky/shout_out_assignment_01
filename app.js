...
var shoutOutArray7 = ["Just the whole group. I feel like when we were given something that a lot of us felt under water with, many in the group stepped up and helped emotionally.", "Thanks to my team: Rom, Brian and Erik, for doing a great job to finish up the project without me. It works perfectly and looks...uh, interesting lol! Thanks for teaching it back to me as well, Brian!", "Alicia is a very nice person. She was very patient with me today when I was in a bad mood and frustrated by code. Thanks, Alicia!", "I would like to give thanks to michael for being a good peer project partner.", "Alicia's speech was really inspiring. I thought she expressed herself in such an open way. It made me really happy to be part of this group.", "Cody was helpful as well as Kelly, Chelsea by sharing their ?'s and ways to work through the struggles.", "EVERYONE -- the support I received during my speech is something I have never felt before. It was amazing. Thank you.", "Thanks for being patient with me today, Michelle! You were an awesome partner and helped me to better understand objects. I was struggling a little and you pulled me through.", "Alicia was super helpful when I was having a notes overwrite disaster during lecture!!"];
...
$("#shoutOut2").on("click", function(){
	...
	for(var i = 0; i < shoutOutArray2.length; i++) {
		$("#secondDiv").append("<li>"+shoutOutArray2[i]+"</li>");
	}
...
$("#shoutOut3").on("click", function(){
	console.log("Hi");
	for(var i = 0; i < shoutOutArray3.length; i++) {
		$("#thirdDiv").append("<li>"+shoutOutArray3[i]+"</li>");
	}
...
$("#shoutOut4").on("click", function(){
	console.log("Hi");
	for(var i = 0; i < shoutOutArray4.length; i++) {
		$("#fourthDiv").append("<li>"+shoutOutArray4[i]+"</li>");
	}
...
$("#shoutOut5").on("click", function(){
	console.log("Hi");
	for(var i = 0; i < shoutOutArray5.length; i++) {
		$("#fifthDiv").append("<li>"+shoutOutArray5[i]+"</li>");
	}
	$("#shoutOut5").fadeOut("fast");
	$("#shoutOut6").fadeIn("fast");
	$("#fourthDiv").slideUp("slow");
});
$("#shoutOut6").on("click", function(){
	console.log("Hi");
	for(var i = 0; i < shoutOutArray6.length; i++) {
		$("#sixthDiv").append("<li>"+shoutOutArray6[i]+"</li>");
	}
	$("#shoutOut6").fadeOut("fast");
	$("#shoutOut7").fadeIn("fast");
	$("#fifthDiv").slideUp("slow");
});
$("#shoutOut7").on("click", function(){
	console.log("Hi");
	for(var i = 0; i < shoutOutArray7.length; i++) {
		$("#seventhhDiv").append("<li>"+shoutOutArray7[i]+"</li>");
	}
	$("#shoutOut7").fadeOut("fast");
	$("#shoutOut8").fadeIn("fast");
	$("#sixthDiv").slideUp("slow");
});
$("#shoutOut8").on("click", function(){
	console.log("Hi");
	for(var i = 0; i < shoutOutArray8.length; i++) {
		$("#eigthDiv").append("<li>"+shoutOutArray8[i]+"</li>");
	}
	$("#shoutOut8").fadeOut("fast");
	$("#shoutOut9").fadeIn("fast");
	$("#seventhDiv").slideUp("slow");
});

$("#shoutOut9").on("click", function(){
